...
INSERT INTO PETSITTER (P_NO, P_TITLE, P_CONTENT, P_SERVICE, CARE_LIST, P_MODE, USER_NO) VALUES (SEQ_PETSITTER.NEXTVAL, '¾ÈÀüÇÏ°í Æí¾ÈÇÏ°Ô µ¹ºÁÁÖ´Â Æê½ÃÆÃ','È£¹Ú°í±¸¸¶, ÈûµåÁ´', 'Èí¿¬ÀÚ, Èûµé´ç', '¾îµð¿¡ ¾²´Â°í', DEFAULT, 2);
INSERT INTO PETSITTER (P_NO, P_TITLE, P_CONTENT, P_SERVICE, CARE_LIST, P_MODE, USER_NO) VALUES (SEQ_PETSITTER.NEXTVAL, '³ª´Â °ïÁê´Ô','È£¹Ú°í±¸¸¶, ÈûµåÁ´', 'Èí¿¬ÀÚ, Èûµé´ç', '¾îµð¿¡ ¾²´Â°í', DEFAULT, 2);
INSERT INTO PETSITTER (P_NO, P_TITLE, P_CONTENT, P_SERVICE, CARE_LIST, P_MODE, USER_NO) VALUES (SEQ_PETSITTER.NEXTVAL, '³ª´Â °ïÁê´Ô','È£¹Ú°í±¸¸¶, ÈûµåÁ´', 'Èí¿¬ÀÚ, Èûµé´ç', '¾îµð¿¡ ¾²´Â°í', DEFAULT, 2);
INSERT INTO PETSITTER (P_NO, P_TITLE, P_CONTENT, P_SERVICE, CARE_LIST, P_MODE, USER_NO) VALUES (SEQ_PETSITTER.NEXTVAL, '³ª´Â °ïÁê´Ô','È£¹Ú°í±¸¸¶, ÈûµåÁ´', 'Èí¿¬ÀÚ, Èûµé´ç', '¾îµð¿¡ ¾²´Â°í', DEFAULT, 2);
INSERT INTO PETSITTER (P_NO, P_TITLE, P_CONTENT, P_SERVICE, CARE_LIST, P_MODE, USER_NO) VALUES (SEQ_PETSITTER.NEXTVAL, '³ª´Â °ïÁê´Ô','È£¹Ú°í±¸¸¶, ÈûµåÁ´', 'Èí¿¬ÀÚ, Èûµé´ç', '¾îµð¿¡ ¾²´Â°í', DEFAULT, 2);
