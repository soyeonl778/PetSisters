...
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-01-10',
         '2023-01-02',
         '우리 아이가 분리불안 증세가 심해서 되도록이면 혼자두지 말아주세요',
         'Y',
         3,
         1);
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-05-15',
         '2022-05-05',
         '하루에 아침 저녁 귀 청소 꼭 해주시고 약도 꼭 먹여주세요',
         'Y',
         4,
         1);  
INSERT INTO RESERVATION 
...
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-02-11',
         '2023-01-26',
         '마운팅을 자주하지만 가만히 내버려두면 알아서 멈추니까 너무 억지로 말리지 말아주세요',
         'Y',
         5,
         1);  
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-02-23',
         '2023-02-16',
         '산책시 목줄 말고 꼭 하네스로 채워서 시켜주세용! 아야 해용!',
         'Y',
         6,
         1);         
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-03-22',
         '2023-03-11',
         '낯을 많이 가리고 소심한 아이니까 잘 지켜봐주세요 ㅠㅠ',
         'Y',
         7,
         1); 
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-03-23',
         '2023-03-19',
         '먹는 약이 좀 많은데 자꾸 뱉어서 먹이기 힘드실거에요 ㅠㅠ 그래도 꼭 먹여주셔야해용 ㅠㅠ',
         'Y',
         8,
         1);        
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-04-04',
         '2023-03-28',
         '잘 때 꼭 침대에서 자려고하는 버릇이 있는데 바닥에 푹신한 쿠션 하나만 깔아서 잠자리 준비해주시면 넘 좋을것같아요!',
         'Y',
         9,
         1);      
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-04-15',
         '2023-04-19',
         '산책할 때 나비나 꽃 구경하는거 너무 좋아하니까 천천히 여유로운 산책 부탁드릴게용!',
         'Y',
         10,
         1);      
INSERT INTO RESERVATION 
...
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-05-22',
         '2023-05-15',
         '우리 아이가 털이 복실복실해서 더위를 많이 타니까 실내 온도 선선하게 유지 부탁드릴게요~',
         'Y',
         12,
         1);    
INSERT INTO RESERVATION 
...
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-06-19',
         '2023-06-10',
         '우리 아이가 소리에 많이 민감한 편이라서 산책할 때 도로 주변은 꼭 피해주세요..',
         'Y',
         15,
         1);        
INSERT INTO RESERVATION 
VALUES ( SEQ_RESERVATION.NEXTVAL,
         ...
         '2022-07-13',
         '2023-06-19',
         '해외 출장 때문에 좀 오래 맡아주셨으면 하는데 병원에서 진료받거나 처방받아야 하는 일이 생기면 다녀와서 추가로 지불해드리겠습니다.',
         'Y',
         14,
         1);    
