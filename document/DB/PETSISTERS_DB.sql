...
DROP TABLE BOARD;
DROP TABLE DOG;
DROP TABLE CS_ATTACHMENT;
DROP TABLE NOTICE;
DROP TABLE QNA;
DROP TABLE MEMBER;

DROP SEQUENCE SEQ_MEMBER;            -- 회원 번호를 발생시킬 시퀀스
DROP SEQUENCE SEQ_QNA;               -- 1:1문의 번호를 발생시킬 시퀀스
DROP SEQUENCE SEQ_NOTICE;            -- 공지사항 번호를 발생시킬 시퀀스
DROP SEQUENCE SEQ_CS_ATTACHMENT;     -- 고객센터 첨부파일 번호를 발생시킬 시퀀스
...
DROP SEQUENCE SEQ_ATTACHMENT;        -- 첨부파일 번호를 발생시킬 시퀀스
...
COMMENT ON COLUMN QNA.A_CONTENT IS '답변내용';
COMMENT ON COLUMN QNA.A_DATE IS '답변일';
COMMENT ON COLUMN QNA.STATUS IS '삭제여부 유지중=Y / 삭제됨=N';
...
COMMENT ON COLUMN CS_ATTACHMENT.FILE_NO IS '파일번호';
COMMENT ON COLUMN CS_ATTACHMENT.ORIGIN_NAME IS '원본파일명';
COMMENT ON COLUMN CS_ATTACHMENT.CHANGE_NAME IS '수정파일명';
COMMENT ON COLUMN CS_ATTACHMENT.FILE_PATH IS '파일경로';
COMMENT ON COLUMN CS_ATTACHMENT.CREATE_DATE IS '파일업로드날짜';
COMMENT ON COLUMN CS_ATTACHMENT.STATUS IS '파일삭제여부 유지중=Y / 삭제됨=N';
COMMENT ON COLUMN CS_ATTACHMENT.REF_QNO IS '공지사항번호';
COMMENT ON COLUMN CS_ATTACHMENT.REF_NNO IS '1:1문의번호';
...
COMMENT ON COLUMN ATTACHMENT.CREATE_DATE IS '파일업로드날짜';
COMMENT ON COLUMN ATTACHMENT.STATUS IS '파일삭제여부 유지중=Y / 삭제됨=N';
...
CREATE TABLE CHAT_ROOM (
    ...
    FOREIGN KEY (USER_NO1) REFERENCES MEMBER (USER_NO),
    FOREIGN KEY (USER_NO2) REFERENCES MEMBER (USER_NO)
);

COMMENT ON COLUMN CHAT_ROOM.ROOM_NO IS '채팅방번호';
COMMENT ON COLUMN CHAT_ROOM.USER_NO1 IS '회원1';
COMMENT ON COLUMN CHAT_ROOM.USER_NO2 IS '회원2';
