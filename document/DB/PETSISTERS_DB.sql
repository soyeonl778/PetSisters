...
CREATE TABLE INQUIRY (
    ...
    REPLY_STATUS VARCHAR2(1) DEFAULT 'N',
    USER_NO NUMBER NOT NULL,
    CONSTRAINT CHK_STATUS_REPLY CHECK (STATUS IN ('Y', 'N') AND REPLY_STATUS IN ('Y', 'N')),
...
COMMENT ON COLUMN INQUIRY.REPLY_STATUS IS '답변여부 NO=N / YES=Y';
...
CREATE TABLE CS_REPLY (
	REP_INO NUMBER PRIMARY KEY,
	REP_ICONTENT VARCHAR2(2000) NOT NULL,
    	CREATE_DATE DATE DEFAULT SYSDATE,
	STATUS VARCHAR2(1) DEFAULT 'Y' CHECK (STATUS IN('Y', 'N')),
	USER_NO NUMBER NOT NULL,
...
COMMENT ON COLUMN CS_REPLY.REP_INO IS '댓글번호';
COMMENT ON COLUMN CS_REPLY.REP_ICONTENT IS '댓글내용';
...
COMMENT ON COLUMN CS_ATTACHMENT.REF_INO IS '참조1:1문의번호';
