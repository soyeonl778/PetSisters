...
CREATE TABLE CHAT_ROOM (
    ...
    FOREIGN KEY (USER_PIC) REFERENCES MEMBER (FILE_PATH),
    FOREIGN KEY (MASTER_NO) REFERENCES MEMBER (USER_NO),
    FOREIGN KEY (MASTER_NICKNAME) REFERENCES MEMBER (USER_NICKNAME),
    FOREIGN KEY (MASTER_PIC) REFERENCES MEMBER (FILE_PATH)
);
