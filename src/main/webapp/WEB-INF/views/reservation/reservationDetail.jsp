...
<link rel="stylesheet"
	href="/resources/css/reservation/reservationDetail.css">
...
<body>
						...
						<div class="middleSection">
							<div class="leftSection">
								...
								<div class="mapClass">
									...
									<div class="petsitterAddress">${ rev.address }</div>
								</div>
								<div id="mapContain">
									<p style="margin-top: -12px">
										<em class="link"> <a href="javascript:void(0);"
											style="text-decoration: none; color: white; cursor: default;">
							...
							<div class="rightWrapper">
								<div class="rigthSection">
									...
									<div class="rightTitright">
										<div class="lineMan">
											<span><fmt:formatNumber value="${ pay.payPrice }"
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2a6a9b34b7a3cf7a7b68ec7c64c444a3&libraries=services"></script>
	<script>
