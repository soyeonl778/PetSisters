...
<link rel="stylesheet"
	href="/resources/css/reservation/careJournalDetail.css">
									...
									<div class="contentContainer">
										...
										<c:forEach var="c" items="${ list }">
											<div class="whoCareArea">
												<div class="whoCare">
													<span class="itsme">${ c.userName }</span> <span>펫시터님의</span>
												</div>
											...
											<div class="contentMain">
												...
												<div class="imgSections">
													<c:forEach var="image"
														items="${fn:split(c.changeName, ',')}">
														<c:if test="${empty image}">
															<img src="/resources/img/main/첨부파일없음.png">
														</c:if>
														<c:if test="${not empty image }">
															<c:set var="trimmedImage" value="${fn:trim(image)}" />
															<img src="${c.filePath}${trimmedImage}" alt=""
																style="height: 150px;">
														</c:if>
													</c:forEach>
												</div>
