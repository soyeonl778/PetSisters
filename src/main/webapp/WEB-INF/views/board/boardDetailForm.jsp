                    ...
                    <div style="height: 100%;">
                      ...
                      <section class="content-section">
                        <div class="content-header">
                          ...
                          <div class="this" style="position: absolute; right: 1px;" onclick="location.href='/createChat.do?masterNo=${b.userNo}'">
                          </div>
                            <div class="content-header-sub-a">
                              ...
                              <div>채팅요청</div>
                              <div>
								<svg style="color: #0888D0;" xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
